...
.Syntax
[source,cli]
xcp verify -fallback-user <fallback_user> -fallback-group <fallback_group> <source><target>

=== -noownership, -fallback-user, and -fallback-group
...
.Syntax
[source,cli]
xcp verify -noownership -fallback-user <fallback_user> -fallback-group <fallback_group> <source><target>
...
.Syntax
[source,cli]
xcp verify -noacls -fallback-user <fallback_user>" -fallback-group <fallback_group><source><target>
...
== verify -onlyacl
Use the `-onlyacl`, `-fallback-user` and `-fallback-group` parameters with the `sync` command to compare only 
the security information between the source and destination.

.Syntax
[source,cli]
xcp verify -onlyacl -preserve-atime -fallback-user <fallback_user> -fallback- group <fallback_group> \\<source_IP_address>\source_share \\<IP address of SMB destination server>\dest_share
