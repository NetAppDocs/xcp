...
*	Add the migration or XCP host user to the "Manage Audit and Security Log Policy in your Active Directory. To locate the 'Manage Auditing and Security Log' Policy on Windows 10, follow these steps:
