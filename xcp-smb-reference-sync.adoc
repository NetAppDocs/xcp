...
| <<smb_sync_exclude,sync -exclude <filter> >> | Only exclude files and directories in the filter.
...
| <<smb_sync_root,sync -root>> | Sync ACLs for the root directory.
...
.Show example
include::./_include/ref-example-smb-sync-exclude.adoc[]
...
.Show example
include::./_include/ref-example-smb-sync-root.adoc[]
