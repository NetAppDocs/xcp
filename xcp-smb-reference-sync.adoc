...
| <<sync_smb_acl, sync -acl>> | Copy security information.
| <<sync_smb_acl,sync -fallback-user FALLBACK_USER >> 
...
| <<sync_smb_acl,sync -fallback-group FALLBACK_GROUP >>
...
| <<smb_sync_onlyacl, sync -onlyacl>> | Copy only the security information.
