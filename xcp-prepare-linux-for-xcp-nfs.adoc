...
Starting XCP 1.8, you can perform data migration as a non-root Linux user. If you are non-root user and you want to perform data migration, see link:[Install XCP] and link:[Configure XCP] for more information.

To perform data migration as a non-root user, you should have following set up:
