...
* In ONTAP, you can use the diagnostic `-atime-update` option to preserve atime. This feature is only available in ONTAP and is helpful if you want to preserve atime of source objects while running XCP.
====
