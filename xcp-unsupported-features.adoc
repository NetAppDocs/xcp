...
* The Hadoop Distributed File System (HDFS) file system does not support symbolic links (symlinks), hard links, or special files.
|ACLs
|XCP does not copy ACLs
|Linux
|XCP can no longer run on earlier distributions of Linux that were supported by XCP 1.6.3.
