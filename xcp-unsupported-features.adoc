...
| Third-party to NetApp NTFS access control lists (ACLs) 
| XCP SMB does not support migration of third-party ACLs from non-NetApp to NetApp systems.
