...
| <<sync_nonames, sync -nonames>> | Excludes user and group names from file listings and reports.
...
| <<sync_dry_run_nonames, sync dry-run -nonames>> | Excludes user and group names from file listings and reports.
