...
|An issue related to security descriptors because the migration user account does not have the required privileges. XCP can only get owner, group, and DACL, it cannot get SACL.
