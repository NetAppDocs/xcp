...
| `xcp: ERROR`:  Incompatible index file. Please use index file generated with current version of XCP only. Alternatively you could download older XCP binary from xcp.netapp.com.
