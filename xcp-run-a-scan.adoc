...
image:xcp-filesize-amc.png[A graph showing the size of files changed over time]
...
Additionally, for SMB shares, you can get the number of alternate data streams files for each file extension by checking the box for alternate data streams before running a scan. 

image:xcp-file-distribution-ads.png[A graph showing how to get the number of alternate data stream files for each file extension in XCP SMB]

=== File Size Distribution by Extension Graph

image:xcp-filesize-dist-ex.png[A graph showing the cumulative size of the different file extensions in a file share.]
...
Additionally, for SMB shares, you can get the number of alternate data streams files for different types by checking the box for alternate data streams before running a scan.  

image:xcp-file-distribution-type.png[A graph showing how to get the number of alternate data stream files for different types for XCP SMB]
