...
[role="tabbed-block"]
====
.Log in using the user credentials provided on installation
--
.. Log in to the GUI using the user credentials provided when you installed File Analytics.
+
image:xcp_image2.png[XCP File Analytics sign in screen]
.. Optionally, change the password to your own password. 
+
If you want to change the password provided on installation to your own password,  select the user icon and select *Change password*.
+
