...
== scan -html
Use the `-html` parameter with the `scan` command to save a HTML statistics report.
...
== scan -csv
Use the `-csv` parameter with the `scan` command to save a CSV statistics report.
