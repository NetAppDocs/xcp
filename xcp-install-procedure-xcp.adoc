---
sidebar: sidebar
permalink: xcp-install-procedure-xcp.html
keywords:
summary:
---

= Install XCP Procedures
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
This section details the system requirements and the procedures to install XCP. If you want to upgrade XCP, delete the current installation and replace it with a new installation of the latest version.
