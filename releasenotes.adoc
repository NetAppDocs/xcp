...
---
= XCP v1.6.7 Release Notes

The link:https://library.netapp.com/ecm/ecm_download_file/ECMLP2877092[XCP v1.6.7 Release Notes] describe new features, upgrade notes, fixed issues, known limitations, and known issues.
