...
---
= XCP v1.9.3 Release Notes

[.lead]
The link:https://library.netapp.com/ecm/ecm_download_file/ECMLP2886695[XCP v1.9.3 Release Notes^] describe new features, upgrade notes, fixed issues, known limitations, and known issues.
