...
---
= XCP v1.9.2 Release Notes

The link:https://library.netapp.com/ecm/ecm_download_file/ECMLP2884968[XCP v1.9.2 Release Notes^] describe new features, upgrade notes, fixed issues, known limitations, and known issues.
