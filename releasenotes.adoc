...
The link:https://library.netapp.com/ecm/ecm_download_file/ECMLP2881500[XCP v1.9 Release Notes^] describe new features, upgrade notes, fixed issues, known limitations, and known issues.
