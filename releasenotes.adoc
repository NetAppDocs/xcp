...
The link:https://library.netapp.com/ecm/ecm_download_file/ECMLP2880112[XCP v1.8 Release Notes^] describe new features, upgrade notes, fixed issues, known limitations, and known issues.
