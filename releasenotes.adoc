...
[.lead]
The link:https://library.netapp.com/ecm/ecm_download_file/
ECMLP3317866[XCP v1.9.4 Release Notes^] describe new features, upgrade notes, fixed issues, known limitations, and known issues.
