...
NOTE: Simple Storage Service (S3) does not support sparse files. Therefore, specifying an S3 bucket as the target destination for `copy -edupe` returns the value "None" for sparse data.
