...
To run XCP 1.9.3 and later, you must obtain a new XCP license from the link:https://xcp.netapp.com/[XCP site^]. Licenses used in earlier releases are not supported in XCP 1.9.3 and later. 
