...
NetApp offers a free 90-day XCP license. You can obtain the license file from the link:https://xcp.netapp.com/[XCP site^]. The licensing portal offers different licensing options. After 90 days you can renew the license for another 90 days using the same portal.
