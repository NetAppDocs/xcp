...
====
----
[root@client1 linux]# ./xcp isync -nomodes <source_ip_address>:/testvol_flex <destination_ip_address>:/dest_vol
...
6m47s
Xcp command : xcp isync -nomods <source_ip_address>:/testvol_flex <destination_ip_address>:/dest_vol
