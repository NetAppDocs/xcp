...
----truncated output ----
225 regular agnostic\Makefile
165 regular agnostic\Makefile.template
0 directory agnostic\tools\limits_finder\vendor\symfony\src
0 directory agnostic\tools\limits_finder\vendor\symfony
0 directory agnostic\tools\limits_finder\vendor
0 directory agnostic\tools\limits_finder
0 directory agnostic\tools
0 directory agnostic
