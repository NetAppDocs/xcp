...
====
----
[root@client1 linux]# ./xcp isync -preserve-atime <source_ip_address>:/testvol_flex <destination_ip_address>:/dest_vol
...
Xcp command : xcp isync -preserve-atime <source_ip_address>:/testvol_flex <destination_ip_address>:/dest_vol
