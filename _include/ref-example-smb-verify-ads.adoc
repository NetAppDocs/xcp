...
====
----
c:\netapp\xcp>xcp verify -ads \\<source_IP_address>\source_share\src \\<dest_IP_address>\dest_share XCP SMB Nightly_dev; (c) 2023 NetApp, Inc.; Licensed to xx [Network Appliance, Inc] until xx yyyy
