...
| <<nfs_scan_stats_csv_html,scan -csv>>| Lists files in the tree statistic report format.
| <<nfs_scan_stats_csv_html,scan -html>>| Lists files in the tree statistic report format.
...
Use the `-stats`, `-csv`, and `-html` parameters with the `scan` command to list files in the tree statistic report formats
