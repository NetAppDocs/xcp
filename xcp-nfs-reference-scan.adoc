...
* XCP reports (.csv, .html) are saved in the catalog location specified in the `xcp.ini` file. The files are stored in the `<catalog path>/catalog/indexes/1/reports` folder. You can view sample reports in the link:https://library.netapp.com/ecm/ecm_download_file/ECMLP2886872[NetApp XCP 1.9.3 reference^].
====
.Syntax
