...
| Parameter
| Description
| <<scan -l and scan -q,scan -l>> | Specifies file listing output formats.
| <<scan -l and scan -q,scan -q>> | Specifies file listing output formats.
| <<stats_csv_html,scan -stats>> | Specifies tree statistic report formats.
| <<nfs_scan_stats_csv_html,scan -csv>>| Specifies tree statistic report formats.
| <<nfs_scan_stats_csv_html,scan -html>>| Specifies tree statistic report formats.
...
Use the `-l` and `-q` parameters with the `scan` command to specify file listing output formats.
...
Use the `-stats`, `-csv`, and `-html` parameters with the `scan` command to specify tree statistic report formats.
